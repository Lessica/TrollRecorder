...
2. **"TrollRecorder"**: Refers to the software legally owned and operated by [@Lessica](https://github.com/Lessica). "TrollRecorder" includes the client applications, applets, WeChat public accounts, Today's headlines, Weibo, and the website of [TrollRecorder](https://trollrecorder.app) legally owned and operated by [@Lessica](https://github.com/Lessica).
